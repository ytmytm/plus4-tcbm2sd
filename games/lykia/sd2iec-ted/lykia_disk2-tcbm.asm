...
.print "Assembling LYKIA-DISK2-TCBM.PRG"
.segmentdef Combined  [outPrg="lykia_disk2-tcbm.prg", segments="Base,PatchDriveType,PatchLoader,PatchExo0,PatchExo", allowOverlap]

.segment Base [start = $1001, max=$ffff]
.var data = LoadBinary("boot2.bin", BF_C64FILE)
