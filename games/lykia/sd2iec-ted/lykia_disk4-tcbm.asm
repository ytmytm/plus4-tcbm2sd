...
.print "Assembling LYKIA-DISK4-TCBM.PRG"
.segmentdef Combined  [outPrg="lykia_disk4-tcbm.prg", segments="Base,PatchDriveType,PatchLoader,PatchExo0,PatchExo", allowOverlap]

.segment Base [start = $1001, max=$ffff]
.var data = LoadBinary("boot4.bin", BF_C64FILE)
